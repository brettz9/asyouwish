...
var wrap = function (obj) {return obj;};

function subprocess (userWrap) {
    wrap = userWrap;
}

subprocess.call = function(options) {
...
subprocess.registerDebugHandler = function(func) {
    gDebugFunc = func;
};
subprocess.registerLogHandler = function(func) {
    gLogFunc = func;
};
