...
Todos:
0) Ensure defaults are reset by new addon update (i.e., use simple prefs) while ensuring long-term storage for specifically approved settings/sites (i.e., not simple prefs)
0) Remember to rebuild and commit included XPI!
0) Destroy chrome branch as already incorporated

0) Utilize tooltips library for select options
