        ...
        notify = function $notify (currentRequestIndex, mainWindow) {
            ...
            */
            privMsg = unapprovedPrivs.reduce(function (prev, priv) {
                    return _('privilegeMessages', prev, aywPrivManager.getPrivMessage(priv)); // This is text, not HTML so can't use line breaks
                }, '');
            ...
            notification = noticeObj.show(
                ...
                'requestPrivs',
                _("This website is asking your permission for the POTENTIALLY VERY DANGEROUS ability to access: %1s", privMsg),
                                   ...
                                   // global PopupNotifications object uses the notification-popup-box
                {
                    ...
                    accessKey: _("accessKeyRefusePermission"),
                    callback: function () {
                ...
                [
                    {
                        label: _("I fully trust this website with the ability to access: %1s", privMsg),
                        accessKey: _("accessKeyTrustWebsite"),
                        callback: function () {
