...
Todos:
1) For FF21 alpha, fix Panel inside widget (see "addon" demos); now showing as empty
2) Dead object errors/memory
3) Namespaced storage
    a) Change from notification hanger to a per-window modal to avoid potential confusion on originating sites (and avoid accidental closings of doorhangers); also allows better control of styling of dialog?
