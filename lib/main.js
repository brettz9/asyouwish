...
0) Dead object errors
0) Change defaultPrivs to return whitelisted if in effect
0) sort privilege whitelist
0) Make way for privilege whitelist to only allow specific namespaces
0) Utilize meta-data "license", "developer" (name, url), "version", "name", "description" in UI, and allow isRegistered to check version/properties?
0) Better i18n-ize options.js (avoiding parentheses within content script JS, etc.)
0) Include full-featured (all AsYouWish methods) "addon" demo
