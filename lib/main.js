...
1) Sort privilege whitelist
1) Make way for privilege whitelist to only allow specific namespaces
1) i18n-ize short priv names too
1) Settle on full sdk paths if required (but avoid "sdk/" prefix for consumers?)
