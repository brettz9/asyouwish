...
1) Test unregister/reregister from website, e.g,. to install addon without restart (ensure same code is ok)?
    a) Utilize meta-data "license", "developer" (name, url), "version", "name", "description"
