...
1) Supply windows, including all open windows on start of the app (e.g., if one is in private mode and another is not)
2) Dead object errors
3) Namespaced storage
4) nsIProcess and demo? https://github.com/ochameau/jetpack-subprocess/issues/5#issuecomment-9783672
...
exports.main = function () {
    ...
    optionsPanel.port.on('addAllowedWebsite', function (website) {
        ...
        try {
            newURI(website); // Ensure first it is a valid website but not throwing errors here
