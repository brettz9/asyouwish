...
Todos:
0) Ensure defaults are reset by new addon update (i.e., use simple prefs) while ensuring long-term storage for specifically approved settings/sites (i.e., not site prefs)
0) Remember to rebuild and commit included XPI!
