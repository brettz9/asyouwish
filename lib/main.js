...
2) Readme todos & Update release notes
    a) remove from allowed: remove from allowed, approved, addons
    ...
    b) After new dialog (with addon section) so dialog is up to date and familiar: Show screenshots of dialog, etc. as part of pages your users must read--pointing them here might save you the trouble, and ensure that it is hosted at a site which should be secure (and where my wiki has not been made public).
*/
(function () {
'use strict';
