...
0) For changes to allowable APIs, see getPrivilegedObject() here in main.js and possiblePrivs in aywPrivManager.js
0) If the SDK may change to allow dynamic loads, make separate library module for editing privilege types so
3rd parties can add their own with permission; see
https://addons.mozilla.org/en-US/developers/docs/sdk/latest/dev-guide/tutorials/reusable-modules.html
   ...
   a) An alternative might be to dynamically create a file to ensure all require's are present
1) Whenever possible, utilize more of the built-in SDK APIs (or make patches?)
    ...
    c) main.js: nsIWindowMediator, nsIFilePicker, nsIIOService
    d) ObserverBuilder.js: nsIObserverService
    e) PopupNotifications.js: nsIFocusManager
    f) specialPowers.js: nsIPrefBranch, nsIObserverService, nsIXMLHttpRequest, nsIXULAppInfo, nsIXULRuntime,
        nsIEventListenerService, nsIDOMRequestService, nsIDebug2, nsIPermissionManager, nsIIOService
    g) subprocess: nsIXULRuntime, nsITimer, nsIScriptableUnicodeConverter, nsIFile, nsIThreadManager
2) If we can i18n add-on name and description or get current locale to know which options.html file to use
rather than requiring the information in the properties file, we can further/better i18n-ize?
Remove need for separate content-script i18n if supported (see also https://bugzilla.mozilla.org/show_bug.cgi?id=825803 )
Make patches?

Todos:
1) Dead object errors/memory
2) Namespaced storage
    a) Change from notification hanger to a per-window modal to avoid
    potential confusion on originating sites (and avoid accidental
    closings of doorhangers); also allows better control of styling of dialog?
...
exports.main = function () {
    ...
    var _ = require('sdk/l10n').get,
        ...
        version = require('sdk/system').version,
        spapiNew = require('./specialpowersAPI'),
        spapiOld = require('./specialpowersAPI-preFF'),
        Spapi = (version.match(/^[2-9][0-9]/) ?  spapiNew : spapiOld).SpecialPowersAPI,
        ...
        options = require('sdk/ui/button/action').ActionButton({
            id: 'ayw-options-btn',
            label: _("AsYouWish_options"),
            icon: data.url('ayw-options/options.png'),
        ...
        */
        getPrivilegedObject = function getPrivilegedObject (privType) {
            ...
            switch (privType) {
                // Globals
                // Still used (requested addition to high-level or low-level docs as missing there)
                case 'sdk/console': obj = console; break; // Posseses "exception" property not present on normal console

                // Top-level
                case 'chrome': obj = chrome; break;

                // Todo: Deprecate old interface?
                // Of little use as specific to this add-on or available already on websites
                // case 'sdk/addon-page': obj = require('sdk/addon-page'); break; // Of little apparent use (AsYouWish-specific) and deprecated
                case 'sdk/l10n': obj = require('sdk/l10n'); break; // Of little apparent use (AsYouWish-specific)
                case 'sdk/notifications': obj = require('sdk/notifications'); break; // Of little apparent use (already available in websites?)
                case 'sdk/self': obj = require('sdk/self'); break; // Of little apparent use (AsYouWish-specific)
                case 'sdk/simple-prefs': obj = require('sdk/simple-prefs'); break; // Of little apparent use (AsYouWish-specific)
                case 'sdk/timers': obj = require('sdk/timers'); break; // Of little apparent use (already available in websites)

                // Should be implementable without SDK and need for privileges
                case 'sdk/base64': obj = require('sdk/base64'); break;
                case 'sdk/querystring': obj = require('sdk/querystring'); break;
                case 'sdk/url': obj = require('sdk/url'); break;
                case 'sdk/lang/functional': obj = require('sdk/lang/functional'); break; // lang/functional
                case 'sdk/lang/type': obj = require('sdk/lang/type'); break; // lang/type

                // High level privs
                case 'sdk/clipboard': obj = require('sdk/clipboard'); break;
                case 'sdk/context-menu': obj = require('sdk/context-menu'); break;
                case 'sdk/hotkeys': obj = require('sdk/hotkeys'); break;
                case 'sdk/indexed-db': obj = require('sdk/indexed-db'); break;
                case 'sdk/page-mod': obj = require('sdk/page-mod'); break;
                case 'sdk/page-worker': obj = require('sdk/page-worker'); break;
                case 'sdk/panel': obj = require('sdk/panel'); break;
                case 'sdk/passwords': obj = require('sdk/passwords'); break;
                case 'sdk/private-browsing': obj = require('sdk/private-browsing'); break;
                case 'sdk/request': obj = require('sdk/request'); break;
                case 'sdk/selection': obj = require('sdk/selection'); break;
                case 'sdk/simple-storage': obj = require('sdk/simple-storage'); break;
                case 'sdk/system': obj = require('sdk/system'); break;
                case 'sdk/tabs': obj = require('sdk/tabs'); break;
                case 'sdk/ui': obj = require('sdk/ui'); break;
                // case 'sdk/widget': obj = require('sdk/widget'); break;
                case 'sdk/windows': obj = require('sdk/windows'); break;
                ...
                case 'sdk/content/mod': obj = require('sdk/content/mod'); break; // content/mod
                // case 'sdk/content/symbiont': obj = require('sdk/content/symbiont'); break; // content/symbiont // Not available in SDK 1.16
                ...
                case 'sdk/places/bookmarks': obj = require('sdk/places/bookmarks'); break; // places/bookmarks
                case 'sdk/places/favicon': obj = require('sdk/places/favicon'); break; // places/favicon
                case 'sdk/places/history': obj = require('sdk/places/history'); break; // places/history
                ...
                case 'sdk/stylesheet/style': obj = require('sdk/stylesheet/style'); break; // stylesheet/style
                case 'sdk/stylesheet/utils': obj = require('sdk/stylesheet/utils'); break; // stylesheet/utils
                
                // case 'sdk/system/child_process': obj = require('sdk/system/child_process'); break; // system/child_process // Not available in SDK 1.16
                case 'sdk/system/environment': obj = require('sdk/system/environment'); break; // environment
                case 'sdk/system/events': obj = require('sdk/system/events'); break; // events
                ...
                case 'sdk/tabs/utils': obj = require('sdk/tabs/utils'); break;
                ...
                case 'sdk/test/utils': obj = require('sdk/test/utils'); break; // test/utils
                
                case 'sdk/ui/button/action': obj = require('sdk/ui/button/action'); break;
                case 'sdk/ui/button/toggle': obj = require('sdk/ui/button/toggle'); break;
                case 'sdk/ui/frame': obj = require('sdk/ui/frame'); break;
                case 'sdk/ui/id': obj = require('sdk/ui/id'); break;
                case 'sdk/ui/sidebar': obj = require('sdk/ui/sidebar'); break;
                case 'sdk/ui/toolbar': obj = require('sdk/ui/toolbar'); break;
                
                case 'sdk/util/array': obj = require('sdk/util/array'); break;
                ...
                case 'sdk/util/match-pattern': obj = require('sdk/util/match-pattern'); break;
                case 'sdk/util/object': obj = require('sdk/util/object'); break;
                ...
                case 'x-subprocess':
                    obj = require('./subprocess/lib/subprocess');
                    obj.addWrapper(function (obj) {
                        return new Spapi().wrap(obj);
                    });
                    break;
                default: // May be possible to get here if allowed in permissions.
                    ...
                    if (privType.match(nsSS)) {
                        obj = require('sdk/simple-storage');
                        if (!obj.storage.namespacedSimpleStorageNamespaces) {
                            obj.storage.namespacedSimpleStorageNamespaces = {};
                        }
                        namespace = privType.replace(nsSS, '');
                        if (!obj.storage.namespacedSimpleStorageNamespaces[namespace]) {
                            obj.storage.namespacedSimpleStorageNamespaces[namespace] = {};
                        }
                        obj = obj.storage.namespacedSimpleStorageNamespaces[namespace];
                        break;
                    }
        ...
        */
        removeRequestsForSite = function (site) {
            ...
            forEachRequest(function (requests, request, item) {
                if (request && request.site === site) {
                    if (requests[item]) {
                        try {
                            request.safeWindow.dispatchEvent(new request.safeWindow.CustomEvent('x-unload'));
                        }
                        finally {
                            timers.setTimeout(function () {
                                if (requests[item]) {
        ...
        setByPref = function (pref) {
            ...
            switch(pref) {
                ...
                case 'whitelistedPrivileges':
                    ...
                    break;
                default:
                    if (pref.indexOf('extensions.asyouwish.siteprivs') > -1) { // Normal privileges now apparently being reported here
                        break;
                    }
        ...
        */
        requestPrivsExport = function requestPrivsExport (setPrefs, currentRequestIndex, successCb, failureCb) {
            ...
            if (!unapprovedPrivs.length && approvedPrivs.length) { // All found (and approved have not been deleted), so call/return with array of objects
                ...
                // Todo: Can't seem to return an array here
                if (request.isSync) {
                    if (setPrefs) {
                        request.safeWindow.location.reload(); // No need to reforce cache, as we just want to ensure the synchronous requires can move forward
                    }
                    else { // If not already approved, this line will currently be meaningless with sync API as notification requires asynchronous callback
                        return approvedObjects[0];
                    }
                }
                else {
        ...
        */
        notify = function $notify (currentRequestIndex) {
            ...
            if (!gBrowser) { // If asking for privileges from within a hidden DOM window, we can't use the activating window
                // mainWindow = windows.browserWindows.activeWindow; // Didn't work
            ...
            */
            privMsg = unapprovedPrivs.reduce(function (prev, priv) {
                    return _("privilege_messages", prev, _("privilege_message", priv, aywPrivManager.getPrivMessage(priv))); // This is text, not HTML so can't use line breaks
                }, '');
            ...
            try {
                ...
                timers.setTimeout(function () { // Try again
    ...
    optionsPanel.port.on('addLocalWebsite', function () {
        ...
        if (fp.show() === nsIFilePicker.returnOK) {
            optionsPanel.show();
            timers.setTimeout(function () { // Ensure there is enough time to open the panel
                optionsPanel.port.emit('addedLocalWebsite', ioSvc.newFileURI(fp.file).spec);
            }, 500);
        }
    });
    ...
    optionsPanel.port.on('addAllowedWebsite', function (website) {
        ...
        try {
            URL(website); // Ensure first it is a valid website but not throwing errors here
    ...
    requestPrivs_Inject = new ContentDocumentGlobalCreatedObserverBuilder({
        ...
        */
        observed: function observed (subject) { // subject is nsIDOMWindow
            var unsafeWindow, mainWindow, AsYouWish, isSync,
            ...
            AsYouWish = { // __exposedProps__ only appears it can work with global object as opposed to global function, etc.
                requestPrivs: function (requestedPrivs, callback, errCallback) {
                    try {
                        var currReqIdx, errBack = wrapErrorFunc(errCallback),
                            /**
                            * @param {Object} requiredObjWithPrivs The returned required object
                            */
                            cb = function () {
                                if (!site || !siteAllowed(site)) { // Setting changes may have since disallowed requests, so we need to check!
                                     errBack('denied', 'callback');
                                     return;
                                 }
                                if (!callback) { // We'll allow synchronous for now (which probably won't have a callback), though call throws error if privileges not already granted
                                    return;
                                }
                                if (!callback) { // We'll allow synchronous for now (which probably won't have a callback), though call throws error if privileges not already granted
                                    return;
                        ...
                        currReqIdx = currentRequestIndex++; // Add to a local variable so it won't change when later adding to a new closure
                        ...
                        */
                        isSync = typeof requestedPrivs === 'string';
                        requests[currReqIdx] = {
                            site: site,
                            ...
                            unapprovedPrivs: [],
                            isSync: isSync,
                            requestedPrivs: (isSync ? [requestedPrivs] : requestedPrivs).slice(0) // Ensure we don't overwrite user's own array
                        };
                        return new Spapi().wrap(requestPrivsExport(false, currReqIdx, null, function () {
                            notify(currReqIdx);
                        }));
                    }
                    catch (e) {
            ...
            unsafeWindow.addEventListener('unload', function () {
                ...
                safeWindow = unsafeWindow = mainWindow = site = AsYouWish = null; // Probably not necessary if requests (and AsYouWish) deleted as contained all references
            });
        }
    });
