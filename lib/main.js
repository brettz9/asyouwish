        ...
        */
        getPrivilegedObject = function getPrivilegedObject (privType) {
            ...
            switch (privType) {
                ...
                // case 'sdk/addon-page': obj = require('sdk/addon-page'); break; // Of little apparent use (AsYouWish-specific)
                ...
                case 'sdk/notifications': obj = require('sdk/notifications'); break;
                ...
                case 'sdk/util/match-pattern': obj = require('sdk/util/match-pattern'); break; // page-mod/match-pattern
