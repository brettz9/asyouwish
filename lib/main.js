...
1) For changes to allowable APIs, see getPrivilegedObject() here in main.js and possiblePrivs in aywPrivManager.js
2) Whenever possible, utilize more of the built-in SDK APIs (or make patches?)
...
3) If the SDK may change to allow dynamic loads, make separate library module for editing privilege types so
...
4) If we can i18n add-on name and description or get current locale to know which options.html file to use
