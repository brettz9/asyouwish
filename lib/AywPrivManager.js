...
var _ = function () { // require('l10n').get
    return arguments[0] + [].slice.call(arguments, 1).join('');
}; 
...
AywPrivManager.prototype = {
        ...
        defaultPrivs: {
            ...
            'addon-kit': {
                clipboard: 'Read from or set your clipboard; better have no secrets in there!',
