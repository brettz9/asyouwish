...
function getRawCmponents(aWindow) {
  ...
  try {
    ...
    if (typeof win.netscape.security.PrivilegeManager == 'object')
      Cu.forcePrivilegedCmponentsForScope(aWindow);
  } catch (e) {}
...
*/
  ...
  getFullCmponents: function() {
    return typeof this.Cmponents.classes == 'object' ? this.Cmponents
                                                      : Cmponents;
  },
   ...
   */
  get Cc() { return wrapPrivileged(this.getFullCmponents().classes); },
  get Ci() { return this.Cmponents.interfaces; },
  get Cu() { return wrapPrivileged(this.getFullCmponents().utils); },
  get Cr() { return wrapPrivileged(this.Cmponents.results); },
  ...
  */
  ...
  getFormFillController: function(window) {
    return Cmponents.classes["@mozilla.org/satchel/form-fill-controller;1"]
                     .getService(Cmponents.interfaces.nsIFormFillController);
  },
  ...
  get XPCOMABI() {
    ...
    var xulRuntime = Cc["@mozilla.org/xre/app-info;1"]
                        .getService(Cmponents.interfaces.nsIXULAppInfo)
