...
function bindDOMWindowUtils(aWindow) {
  ...
  var util = aWindow.QueryInterface(Cmponents.interfaces.nsIInterfaceRequestor)
                   .getInterface(Cmponents.interfaces.nsIDOMWindowUtils);
...
*/
   ...
   */
  get Cc() { return wrapPrivileged(this.Cmponents).classes; },
  get Ci() { return this.Cmponents.interfaces; },
  get Cu() { return wrapPrivileged(this.Cmponents).utils; },
  get Cr() { return wrapPrivileged(this.Cmponents).results; },

  /*
   * SpecialPowers.getRawCmponents() allows content to get a reference to the
   * naked (non-SpecialPowers-wrapped) Cmponents object for its scope. This
  ...
  pushPrefEnv: function(inPrefs, callback) {
    var prefs = Cmponents.classes["@mozilla.org/preferences-service;1"].
                           getService(Cmponents.interfaces.nsIPrefBranch);
